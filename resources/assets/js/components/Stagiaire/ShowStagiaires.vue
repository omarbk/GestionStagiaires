 ...
 <div class="row">
       <div class="col-auto" v-for="stagiaire of stagiaires.data" :key="stagiaire.id_stagiaire" >
            ...
            <div class="card-body">
                ...
                <div class="card-text">
                    ...
                    <hr>
                    <div class="widthTextCard">Specialité : {{stagiaire.specialite_stagiaire}}</div>
                    <hr>
                </div>
    ...
    <div class="form-group row">
                 <label for="reference" class="col-sm-3 col-form-label">Date de début du  stage : </label>
                    <div class="col-sm-9">
                    <b-form-input  type="date" v-model="dateDebutStage" class="form-control" id="dateD" placeholder="" required/>
                    </div>
                </div>
