    ...
    <div class="loading" v-if="loading">
     ...
     <div v-if="!loading" >
               <div class="text-center pull-right" >
                  <div class=" btnMarge">
        <div class="col">
               <div v-if="eval=='effectue'">
        <a class="float-right btn btn-primary" @click="redirect_To_ShowStagesEffectues(stage)"> <i class="fas fa-long-arrow-alt-left"></i> </a>
               </div>
              <!--  <div v-if="eval=='actuel'"> -->
                  <div v-else> 
        <a class="float-right btn btn-primary" @click="redirect_To_ShowAbsencesActuel(stage)"> <i class="fas fa-long-arrow-alt-left"></i> </a>
               </div>
        </div>
...
<div class="row ">
                ...
                <div class="form-group row">  
                        <label for="reference_paiement"  class="col-sm-5 " >Année Universitaire : </label>
                        <div class="col-sm-5">
                        {{stage.annee_universitaire_stagiaire}} 
                    </div>
                         </div> 
  ...
  <div class="col-md-5 col-sm-10">
                ...
                <div class="form-group row"> 
                        <label for="reference_paiement"  class="col-sm-5 " >Niveau d'Etude : </label> 
                        <div class="col-sm-5">
                ...
                <div class="form-group row"> 
                    ...
                    {{stage.prenom_stagiaire}} 
                     ...
                     <div class="col-md-2 col-sm-4">
                                         <div class="form-group row"> 
                        <label for="reference_paiement"  class="col-sm-5 " >N° : </label> 
                        <div class="col-sm-5">
                   {{stage.id_stagiaire}} 
                     </div>
                        </div>
...
<div class="row ">
                ...
                <div class="form-group row"> 
                        <label for="reference_paiement"  class="col-sm-5 " >Période de Stage : </label> 
                        <div class="col-sm-5">
                    <strong>du </strong>
                    
                     {{stage.dateDebut_stage}} <strong> au </strong>
                ...
                <div class="form-group row"> 
                        <label for="reference_paiement"  class="col-sm-5 " >Hospital : </label> 
                        <div class="col-sm-5">
                    {{stage.nom_hospitalier}} 
                      </div>
                                             </div>
            ...
            <div class="row ">      
                ...
                <div class="form-group row"> 
                        <label for="reference_paiement"  class="col-sm-5 " >Service : </label> 
                    {{stage.service_evaluateur}} 
                    </div>
                              </div>
                ...
                <div class="form-group row"> 
                        <label for="reference_paiement"  class="col-sm-5 " >Nom du MS : </label> 
...
<div class="col-md-6 col-sm-12">
                ...
                <div class="form-group row">
                    <label for="reference_paiement"  class="col-sm-6 " >Commentaire : </label>
                    <div class="col-sm-6">
                 ...
                 <div class="form-group row">
                    <label for="reference_paiement"  class="col-sm-6 " >Nombre des Absences non Justifié : </label>
                    <div class="col-sm-6">
                 ...
                 <div class="form-group row">
                    <label for="reference_paiement"  class="col-sm-6 " >Etat : </label>
      ...
      <div class="col-md-6 col-sm-12">
          <div class="form-group row">
            <label for="staticEmail" class="col-sm-4 ">Note Fin de Stage </label>
            <div class="col-sm-8">
       ...
       <div class="form-group row">
          ...
          <div class="form-group row">
            <label for="staticEmail" class="col-sm-4 ">Moyenne de Stage </label>
            <div class="col-sm-8">
...
methods: { 
       ...
       getStagiairesParEvaluation(stage){
 axios.get('/getStagiairesParEvaluation/',{ params: {id_stagiaire:stage.id_stagiaire,id_stage:this.id_stage } })
                .then((response) => {
                                                            this.loading = false;
                    this.stage = response.data.stagiaires[0];
 ...
 axios.get('/getObjectifsNotesStage/',{ params: {id_stagiaire:stage.id_stagiaire,id_stage:stage.id_stage } })
                .then((response) => {
                                                           this.loading = false;
     ...
     getTypeObjectifs(){
        ...
        console.log('stage')
                      console.log(this.stage)
                     this.$router.push({ name: 'ShowAbsencesActuel', params: { stage:stage,id_stage:this.id_stage}});
    ...
    fetchData(){
                this.loading = true
                     ...
                     console.log('====== ok =====')
        console.log(this.$route.params.stage.id_stage)
        this.id_stage=this.$route.params.stage.id_stage;
        this.eval=this.$route.params.eval;
        console.log('====== xxxxx =====')
        console.log(this.$route.params.eval)
        console.log(this.$route.params.stage.fk_evaluation)
        this.evaluation.fk_stagiaire=this.$route.params.stage.id_stagiaire;
        this.getTypeObjectifs();
        this.getStagiairesParEvaluation(this.$route.params.stage);
