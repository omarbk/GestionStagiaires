...
<div v-if="!loading">
        ...
        <div class="text-center pull-right" >
                  <div class=" btnMarge">
        <div class="col">
    <button class="float-right btn btn-secondary" @click="redirect_To_AddAbsences" ><i class="fas fa-plus-circle"/> Ajouter </button>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr  v-for="absence of absences.data" :key="absence.id_absence" >
                                        ...
                                        <td  class="optionsWidth"> 
                                         <a class="btn btn-success "  @click="redirect_To_EditAbsences(absence.id_absence)" ><i class="fas fa-edit d-inline-block"></i></a>
                                             <a @click="deleteAbsence(absence)" class="btn btn-danger"><i class="fas fa-trash-alt d-inline-block"></i></a></td>                                 
                                    </tr>
...
//absences 
 ...
 methods:{
             redirect_To_AddAbsences(){
                     this.$router.push({ name: 'AddAbsence', params: { stagiaire:this.$route.params.stagiaire,fk_evaluateur:this.$route.params.fk_evaluateur}});
            },
            

             redirect_To_EditAbsences(id_absence){
                     this.$router.push({ name: 'EditAbsence', params: { stagiaire:this.$route.params.stagiaire,fk_evaluateur:this.$route.params.fk_evaluateur,id_absence:id_absence}});
            },
  ...
  /* axios.get('/getGroupes?page='+this.groupes.current_page+'')
    ...
    deleteAbsence:function(absence){
                        ...
                        if (result.value) {
                            axios.delete('/deleteAbsence/'+absence.id_absence).then(
                                        response => {
