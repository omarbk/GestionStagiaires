 ...
 axios.get('/getObjectifsNotes/'+id_stagiaire)
    ...
    addEvaluation(){ 
           ...
           console.log(this.objectif);
              ...
              axios.post('/addEvaluation',{evaluation:this.evaluation,objectifs:this.objectifs,notes:this.notes,totalNote:this.totalNote}).then(response => {  
                    //console.log(response.data.objectif);   
                    console.log('objectif Bien ajouter !');
                    this.$router.push({ name: 'ShowEvaluation', params: { success: "add"  }});
