...
methods: { 
  ...
  return Math.round(number * factor) / factor;
    ...
    addBonCommande(){
            ...
            console.log('----------- TVA summ -----------')
            console.log(this.tva_total)
 ...
 getDevisD(id_devis){
        ...
        countBonCommandes(){
                ...
                .then((response) => {
                    ...
                    var year  = yyyy;
                    this.bonCommande.reference_bc='C-'+year+'-'+response.data.count;
                    this.modePaiement.fk_document='C-'+year+'-'+response.data.count;
                    this.fk_document_cmd='C-'+year+'-'+response.data.count;
...
computed:{
    TotalBonCommande(){
        ...
        for (let index = 0; index < this.commandes.length; index++) {
            ...
            console.log('------------------------------------------------- taux ')
            console.log(this.commandes[index].taux_tva)
